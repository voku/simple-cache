 ...
 * FileSimpleCacheTest
 */
class FileSimpleCacheTest extends \PHPUnit\Framework\TestCase
{
  ...
  {
    self::assertSame('voku\cache\AdapterFileSimple', $this->cache->getUsedAdapterClassName());
  }
  ...
  {
    $this->adapter = new AdapterFileSimple();
